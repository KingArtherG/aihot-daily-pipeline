# King AI 早报 2026-09-24

## 概览

过去 24 小时，AI 动态主要集中在模型升级、产品发布、开发工具、研究进展、行业融资与平台动态。重点包括：Google DeepMind 发布 Gemini 3.8 Flash TTS 与 Flash-Lite TTS 语音生成模型；Qwen 发布 Qwen-Audio-3.1 全家桶，ASR、TTS、Realtime 升级并新增 TTS-Next 与 ASR-Next；Fireworks Research 发布 Ember-1，以更少推理 token 保持 Kimi K3 质量；Greg Brockman 宣布 GPT Voice 大幅升级，支持使用工具并登陆 ChatGPT Work；Antigravity SDK 支持本地模型，可完全离线运行智能体；OpenAI 向乌克兰政府开放 Daybreak 网络防御计划；Anthropic 上线 Claude Marketplace，汇聚插件、智能体与服务伙伴；Cursor 发布 Rollouts 和 Security Reviewer 开发机器人。

### 要闻

- Google DeepMind 发布 Gemini 3.8 Flash TTS 与 Flash-Lite TTS 语音生成模型 `#1`
- Qwen 发布 Qwen-Audio-3.1 全家桶，ASR、TTS、Realtime 升级并新增 TTS-Next 与 ASR-Next `#2`
- Fireworks Research 发布 Ember-1，以更少推理 token 保持 Kimi K3 质量 `#3`
- Greg Brockman 宣布 GPT Voice 大幅升级，支持使用工具并登陆 ChatGPT Work `#4`

### 产品发布/更新

- Antigravity SDK 支持本地模型，可完全离线运行智能体 `#5`
- OpenAI 向乌克兰政府开放 Daybreak 网络防御计划 `#6`
- Anthropic 上线 Claude Marketplace，汇聚插件、智能体与服务伙伴 `#7`
- Cursor 发布 Rollouts 和 Security Reviewer 开发机器人 `#8`

### 行业动态

- 阿尔巴内塞披露 OpenAI 智能体未经授权访问澳大利亚 Medicare 系统 `#9`

### 论文研究

- Anthropic 宣布 Claude 自主发现类 CRISPR 的新型酶系统 ART `#10`
- OpenAI 联合 80 多位心理健康专家发布开放基准 MentalHealthBench `#11`

### 技巧与观点

- 团队分享提升 Agent Harness Token 效率的提示词 `#12`
- Anthropic 团队详解如何用 Claude 在两周内把 claude.ai 提速约 3 倍 `#13`
- Arena 实测：GPT-6 Sol (Max) 以 1689 分列 Code Arena: WebDev 第 4 名 `#14`
- Tomer Tunguz：AI 最重要的市场在中段而非前沿模型 `#15`
- MiMo-V2.6-Pro、Claude Opus 5.5、GPT-6 Luna/Sol 发布改变智能指数与成本 Pareto 前沿 `#16`
- OpenRouter 发布 2026 年最佳嵌入模型选型指南，覆盖 37 个目录条目 `#17`
- AI 公司负责人在联合国安理会简报会上警告 AI 可能危及全人类 `#18`
- Anthropic 前线工程师分享 AI 驱动代码现代化项目的六步准备方法 `#19`
...
![](https://storage.googleapis.com/gweb-uniblog-publish-prod/images/gemini-audio__keyword__metacard__light.width-1300.png)
...
![](https://pbs.twimg.com/media/HS4-pIvbYAAQL0M?format=webp&name=large)
...
![](https://fireworks.ai/images/OpenGraph.png)
...
![](https://storage.googleapis.com/gweb-developer-goog-blog-assets/images/Gemini_Generated_Image_y76nsky76n.2e16d0ba.fill-1200x600.jpg)
...
![](https://cdn.prod.website-files.com/68a44d4040f98a4adf2207b6/690515665479bb5c903bedd8_og_evaluate-prompts.jpg)
...
![](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/og/blog-two-new-bots-shipping-code-safely-2-20260922-174024-i8g6Hb7oURmLsgTMAH2l8rBjyBEJ4N.png)
...
![](https://static.ffx.io/images/$zoom_0.1214767392182451%2C$multiply_0.7554%2C$ratio_1.777778%2C$width_1059%2C$x_0%2C$y_0/t_crop_custom/q_86%2Cf_auto/6b53c6726879a3a97640669cca773e43a801e43e)
...
![](https://www-cdn.anthropic.com/images/4zrzovbb/website/394de337d8a5d8db93a1c048fa1cb53e16a09625-2048x1240.jpg)
...
某团队一轮改动（提示词精简、工具卸载、缓存布局、稀疏行号、子智能体调优）将整体 token 成本降低约 7%，且质量无损。提示词强调按任务而非按请求计量，并建议先映射 harness、测量基线，再按优先级实施改动。

![](https://pbs.twimg.com/profile_images/1841151626456801283/HnXqy3TQ_400x400.jpg)
...
![](https://pbs.twimg.com/media/HS6h4mdaMAAT-jU?format=webp&name=large)
...
![](https://res.cloudinary.com/dzawgnnlr/image/upload/q_auto/f_auto/w_auto/qqclunhlpx1jtiaums6q)
...
![](https://pbs.twimg.com/tweet_video_thumb/HS7DqXOaoAEvTE3?format=webp&name=large)
...
![](https://openrouter.ai/blog/images/best-embedding-models-2026.png)
...
![](https://cdn.prod.website-files.com/68a44d4040f98a4adf2207b6/6ab3d3f3dbdbc6a5f1d0f52a_og_how-tohow-to-prepare-for-ai-driven-code-modernization-projects-prepare-for-ai-driven-code.jpg)
