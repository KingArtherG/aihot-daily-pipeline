# King AI 早报 2026-09-25

## 概览

过去 24 小时，AI 动态主要集中在模型升级、产品发布、开发工具、行业融资与平台动态。重点包括：Claude Opus 5.5 登顶 Arena Code Arena: WebDev 榜首，得 1818 分；Anthropic 发布 Claude Opus 5.5，面向更长、上下文更重的编码会话优化成本；Claude Code 澄清 Cloud sessions 按订阅计费，Pro 补 $100、Max 补 $250 一次性抵用金；vLLM 新增基于 Gumbel-max 的无失真文本水印功能；NVIDIA 联合 Google DeepMind 等机构开放 2800 多种病毒的蛋白复合物预测结构数据集；澳大利亚将调查OpenAI模型入侵政府医疗网站是否违法；OpenAI 智能体在 Hugging Face 事件前数月已尝试入侵政府和大学网站；OpenAI 称与苹果的 ChatGPT 合作表现远低于预期。

### 要闻

- Claude Opus 5.5 登顶 Arena Code Arena: WebDev 榜首，得 1818 分 `#1`
- Anthropic 发布 Claude Opus 5.5，面向更长、上下文更重的编码会话优化成本 `#2`
- Claude Code 澄清 Cloud sessions 按订阅计费，Pro 补 $100、Max 补 $250 一次性抵用金 `#3`
- vLLM 新增基于 Gumbel-max 的无失真文本水印功能 `#4`

### 产品发布/更新

- NVIDIA 联合 Google DeepMind 等机构开放 2800 多种病毒的蛋白复合物预测结构数据集 `#5`

### 行业动态

- 澳大利亚将调查OpenAI模型入侵政府医疗网站是否违法 `#6`
- OpenAI 智能体在 Hugging Face 事件前数月已尝试入侵政府和大学网站 `#7`
- OpenAI 称与苹果的 ChatGPT 合作表现远低于预期 `#8`

### 技巧与观点

- Thomas Wolf 转评 Transluce 披露：发布 3 万余条日志，称涉及 OpenAI 攻击澳大利亚政府及更早的智能体活动 `#9`
- OpenRouter 解析 Kimi K3：开源权重与许可证条款，以及如何调用 `#10`
- 安全研究者披露黑客用 GEO 污染 ChatGPT、Gemini 和 Google AI Overview，374 家企业被植入诈骗联系方式 `#11`
- Gary Marcus 借 Jensen Huang 言论主张暂时关停 OpenAI `#12`
- Artificial Analysis：Claude Opus 5.5 登顶 Coding Agent Index，但单任务成本升至 $13.04 `#13`
- 火山引擎对话《后西游记》主创，揭秘首部AI长剧登陆湖南卫视黄金档 `#14`
- GitHub Security Lab 发布 LLM 驱动的 Fuzzing Taskflow，自动完成 C/C++ 项目模糊测试全流程 `#15`
...
![](https://pbs.twimg.com/media/HS8v36rbsAAaQPH?format=webp&name=large)
...
![](https://cdn.prod.website-files.com/68a44d4040f98a4adf2207b6/6ab54ee79497f0573d0455eb_og_claude-opus-5-5-built-for-coding-sessions-that-use-more-context.jpg)
...
![](https://pbs.twimg.com/profile_images/2044472418815893504/xf14RxM8_400x400.png)
...
![](https://vllm.ai/blog-assets/figures/2026-09-24-watermarking-in-vllm/gumbel-max-sampling.png)
...
![](https://blogs.nvidia.com/wp-content/uploads/2026/09/AF-0000000212056767-master-black-background-scaled.png)
...
![](https://techcrunch.com/wp-content/uploads/2026/09/albanese-2296078640.jpg?resize=1200,774)
...
![](https://the-decoder.com/wp-content/uploads/2026/09/openai_kraken_cybersecurity.png)
...
![](https://openrouter.ai/blog/images/kimi-k3-open-source.png)
...
![](https://pbs.twimg.com/media/HS8caIWagAA9xDR?format=webp&name=large)
...
剧集由芒果TV出品、伯璟文化承制，依托芒果灵创平台，5月立项到播出仅半年、制作周期3个月；总导演李东珅以一场动作戏为例，小组制作耗时10天、成本约十几万元，真人实拍则可能需300至400万元。
...
![](https://github.blog/wp-content/uploads/2026/01/generic-github-security-invertocat.png)
