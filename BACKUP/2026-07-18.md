# King AI 早报 2026-07-18

## 概览

过去 24 小时，AI 动态主要集中在模型升级、产品发布、开发工具、研究进展、行业融资与平台动态。重点包括：Sora 2 视频克隆效果惊人，真假难辨；Kimi K3 登顶前端编码榜，开放权重挑战闭源双巨头；NVIDIA 发布 Nemotron 3 Embed 系列，8B 版本在 RTEB 基准上排名第一；通义实验室发布 Wan-Streamer v0.2，端到端响应延迟仅 550ms；Claude Code v2.1.212 发布；Apple 起诉 OpenAI：诉讼背后是竞争焦虑还是时机博弈？；苹果与 OpenAI 法律战升级：约 40 名前员工收到苹果律师函；月之暗面在GTC 2026披露Kimi K2.5技术路线：用MuonClip、线性注意力与Agent Swarm重构三大基础组件。

### 要闻

- Sora 2 视频克隆效果惊人，真假难辨 `#1`
- Kimi K3 登顶前端编码榜，开放权重挑战闭源双巨头 `#2`
- NVIDIA 发布 Nemotron 3 Embed 系列，8B 版本在 RTEB 基准上排名第一 `#3`
- 通义实验室发布 Wan-Streamer v0.2，端到端响应延迟仅 550ms `#4`

### 产品发布/更新

- Claude Code v2.1.212 发布 `#5`

### 行业动态

- Apple 起诉 OpenAI：诉讼背后是竞争焦虑还是时机博弈？ `#6`
- 苹果与 OpenAI 法律战升级：约 40 名前员工收到苹果律师函 `#7`

### 论文研究

- 月之暗面在GTC 2026披露Kimi K2.5技术路线：用MuonClip、线性注意力与Agent Swarm重构三大基础组件 `#8`
- Schema Harness 在 ARC-AGI-3 公开集上取得约 99% 成绩 `#9`
- 美团LongCat发布LoHoSearch：更难搜索智能体基准 `#10`
- Apple 研究：Show Me Examples — 从图像集推断视觉概念 `#11`

### 技巧与观点

- 八天四款前沿模型发布，Kimi K3 跻身第三 `#12`
- 首届“小有可为”大赛乡村教育一等奖作品“智绘科普”技术拆解 `#13`
- 生成式人工智能是一场工程灾难：AI公司抢购70%高端内存，推高电脑价格 `#14`
- Cursor 评估负责人确认 Claude Fable 5 在 CursorBench 达 72.9% 新高 `#15`
- OpenAI 提出 AI 时代记分卡：“有用智能每美元”衡量实际工作价值 `#16`
- Anthropic 副首席信息安全官发布智能体 AI 风险评估框架：零风险不是目标 `#17`
- AI 时代“小需求”的成本逻辑变了：GitHub 博客谈工程决策新范式 `#18`
...
![](https://pbs.twimg.com/profile_images/1900416323030581248/LRlv5e8n_200x200.jpg)
...
![](https://pbs.twimg.com/amplify_video_thumb/2077980897169600514/img/_cwPSpVF5ytFBqnn.jpg)
...
![](https://www.marktechpost.com/wp-content/uploads/2026/07/blog19132-26.png)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/C7WsXj9icr60BjOHicGhYcrgJo5fJ1qrM0lOibujGicfjC6BZo3nHJnsNFMRzLm92ckaJPyzjJ2fSkuvZXKDdYCvibXUd3iczTiaiatavwdLfqL1bOs/0?wx_fmt=jpeg)
...
Claude Code v2.1.212 新增 `/fork` 命令，可将当前对话复制到新后台会话中独立运行。新增会话级 WebSearch 调用上限（默认 200）和子智能体生成上限（默认 200），防止失控循环。

MCP 工具调用超过 2 分钟自动移至后台，并修复了计划模式自动执行文件修改命令等多项问题。

![](https://opengraph.githubassets.com/759e0da341eacbdc9a46fb49ed2f24a54732bf313d4b0d0db6406900561157ee/anthropics/claude-code/releases/tag/v2.1.212)
...
Apple 对 OpenAI 提起诉讼，指控其存在多项不当行为，尽管许多专家认为部分指控属于行业惯例。

此举正值 Apple 发布新版软件公测版（以新 Siri AI 为核心）之际，外界猜测 Apple 究竟是担忧 OpenAI 成为潜在竞争对手，还是想利用 OpenAI 的弱势期获利。

![](https://platform.theverge.com/wp-content/uploads/sites/2/2026/07/VRG_VST_071626_Site.jpg?quality=90&strip=all&crop=0%2C10.732984293194%2C100%2C78.534031413613&w=1200)
...
苹果已向约40名就职于OpenAI的前员工发出律师函，要求保存相关文件。此前苹果起诉OpenAI及两名前员工，指控其通过挖角获取商业机密以加速AI硬件研发。

苹果称已有超400名前员工在OpenAI工作，正寻求法院禁令阻止OpenAI使用苹果信息并要求归还机密。
...
月之暗面CEO杨植麟在GTC 2026演讲中提出用MuonClip优化器替代Adam，可将数据利用效率提升近一倍。

同时推出Kimi Linear线性注意力，在百万Token上下文下全面超越全注意力；Agent Swarm已支持300个Agent并行工作。

![](https://pbs.twimg.com/amplify_video_thumb/2078170238642786304/img/A8w--lcpOC1AGzjY.jpg)
...
该框架不修改模型权重，而是将原始观测转化为可编辑程序，联合解决状态归因和机制发现问题。此前最强模型 GPT-5.6 Sol 在半私有集上仅得 7.78%。
...
在11个前沿模型测试中，最佳得分仅34.74%，远低于当前模型在BrowseComp上约90%的成绩；上下文策略仅带来+6.8个百分点的提升。该基准包含544道问题、11个领域，采用树与图结构，已开源。

![](https://pbs.twimg.com/media/HNb1a5VbAAA8Lpy.jpg:large)
...
Apple 机器学习研究团队提出一种方法，让视觉语言模型（VLM）仅从图像集示例中推断视觉概念，无需文本指令。该方法通过对比示例图像与候选图像，使模型捕捉颜色、纹理等视觉规律，在多个概念推理基准上提升准确率。

该研究目前为学术论文，未公布模型或 API 可用性。
...
![](https://pbs.twimg.com/media/HNcf2upbMAALvLu.jpg:large)
...
首届“小有可为”大赛乡村教育赛道一等奖作品“智绘科普”采用 Qwen3.5-397B-A17B 大语言模型与 Manim 动画引擎，通过多Agent分阶段协作与自动修复机制，将知识主题转化为可控、可编辑的教学动画。

系统包含规划、草稿、实现、审查、合成五个阶段，渲染失败时可自动提取日志并修复，该工程范式可迁移至其他赛道。

![](https://mmbiz.qpic.cn/mmbiz_jpg/C7WsXj9icr618BrIzwygxEnvbIaoxJLSmSBG1T02InaeSO8mmF57UMyuB84Ck62hiapGcbemEkuIsm1dfZf0lx9AB6fLykqR7w1OuNDNG0P88/0?wx_fmt=jpeg)
...
![](https://cdn.theatlantic.com/thumbor/pRTmRKbPCznhWXFQOWNZUwOpnIg=/0x83:2000x1125/1200x625/media/img/mt/2026/07/2026_07_10_Reisner_Gen_Ai_Engineering_Disaster/original.jpg)
...
![](https://cdn.prod.website-files.com/68a44d4040f98a4adf2207b6/6a5a535ed54d363ae50d563a_2026_WATF_Cursor_YT_Thumb_16x9.jpg)
...
Anthropic 副首席信息安全官 Jason Clinton 分享了其团队在采用智能体 AI 过程中的经验教训，并提出了一套用于安全构建和部署智能体的风险评估框架。

该框架通过四个核心问题（摄入的不可信内容、可执行的操作、失控时的爆炸半径、可观测性）来评估风险，并强调“最小代理权限”原则。Anthropic 的默认策略是管理员控制的分阶段推出，并指出与意图偏离的智能体在行为上无异于内部攻击。

![](https://cdn.prod.website-files.com/68a44d4040f98a4adf2207b6/6a03655fab957ea9f4e6c71b_og_how-anthropic-uses-claude-cybersecurity.jpg)
