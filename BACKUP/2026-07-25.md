# King AI 早报 2026-07-25

## 概览

过去 24 小时，AI 动态主要集中在模型升级、产品发布、开发工具、研究进展、行业融资与平台动态。重点包括：Anthropic 发布 Claude Opus 5；蚂蚁百灵发布Ling-3.0-flash原生混合推理模型；FLUX 3 x mimic：新一代视频动作模型；Midjourney V8.2 发布：专注美学提升与个性化理解；Black Forest Labs 发布 FLUX 3 多模态模型，支持单次生成 20 秒视频与原生音频；Runway Agent 推出自然语言工作流功能；百度搭子更新：电脑手机接力、桌面端内嵌浏览器上线，复杂任务可跨端连续执行；OpenRouter 推出 Classifiers 测试版：自动标记 AI 请求的用途与成本归属。

### 要闻

- Anthropic 发布 Claude Opus 5 `#1`
- 蚂蚁百灵发布Ling-3.0-flash原生混合推理模型 `#2`
- FLUX 3 x mimic：新一代视频动作模型 `#3`
- Midjourney V8.2 发布：专注美学提升与个性化理解 `#4`

### 模型发布/更新

- Black Forest Labs 发布 FLUX 3 多模态模型，支持单次生成 20 秒视频与原生音频 `#5`

### 产品发布/更新

- Runway Agent 推出自然语言工作流功能 `#6`
- 百度搭子更新：电脑手机接力、桌面端内嵌浏览器上线，复杂任务可跨端连续执行 `#7`
- OpenRouter 推出 Classifiers 测试版：自动标记 AI 请求的用途与成本归属 `#8`
- Claude Code v2.1.219 发布：新增 Claude Opus 5，支持 1M 上下文与嵌套子智能体 `#9`

### 行业动态

- 英伟达、微软和Meta联合警告：应避免对开放权重模型过度监管 `#10`
- 微软阐述开源模型助力美国竞争力路径 `#11`
- Kimi K3 在网络安全漏洞利用测试中大幅落后美国前沿模型，知识蒸馏或为原因 `#12`

### 论文研究

- Anthropic 联合 Andon Labs 发布 Drone-Bench，评估 AI 模型自主操控无人机执行定位追踪任务的能力 `#13`
- Apple 提出 LEAD 方法，破解长程推理中的“不可恢复瓶颈” `#14`

### 技巧与观点

- Claude-thermos：保持 Claude 会话缓存热度，避免重新编码费用 `#15`
- Claude 5 代模型上下文工程新规则：Claude Code 系统提示词精简超 80% `#16`
- Claude Design 产品设计师 Nate Parrott 分享如何用其探索视觉创意 `#17`
- Claude 模型家族详解：如何为工作负载选择最佳模型 `#18`
...
![](https://cdn.sanity.io/images/4zrzovbb/website/54b7ab1d2c2521f83ae5d2da5f9d99321c370d24-2880x1620.png)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/9DBpSju5urAF9yuHVN5MnzImzh41HC0Oiamn4hCZkXVey4HCT9uq6icuTCncabo5RRyFm4swWO5icgp5j6M8VEqr6AoNgiasPNuPUJpRO7qIp5I/0?wx_fmt=jpeg)
...
Black Forest Labs 发布多模态基础模型 FLUX 3，联合训练图像、视频和音频，其中视频预测占训练算力的 95% 以上。该模型与机器人公司 mimic 合作推出 FLUX-mimic，已在奥迪生产线上测试部署。

加入动作预测后，视频生成质量最初下降最多 10%，但经 3500 步训练后恢复原有水平。

![](https://bfl.ai/api/og/blog/flux-3-mimic)
...
Midjourney 今日推出 V8.2 图像模型，重点提升美学质量、图像创意与个性化表现。低质量图像出现频率将显著降低，个性化功能能更精准理解用户审美偏好。

V8.2 的个性化配置文件拥有更大、更优的图像选择池，建议用户尝试新旧配置文件体验最新版本。
...
Black Forest Labs 以 Early Access 方式推出 FLUX 3 多模态基础模型，采用统一架构联合学习图像、视频和音频。

该模型基于 Self-Flow 学习框架扩展，可在单次生成中输出最长 20 秒视频并附带原生音频，支持文生视频、图生视频、多镜头串联等任务。
...
![](https://pbs.twimg.com/amplify_video_thumb/2080648612023824384/img/E_scYfhSEB6-38Z1.jpg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/jfeia7EjCFYrlZzyic0EUCS4r8prXJhYq6gCBlqT1WqDlxia0LYwytNcnjXXFAMKxGsFiaFOVw0IP9lGibibickeH5a0Chic0FUwOU5ppJsA7osjLvQ/0?wx_fmt=jpeg)
...
![](https://openrouter.ai/blog/images/classifiers.png)
...
![](https://opengraph.githubassets.com/24526cd9f128be20facd538d7b2f3d7cdfe427ae03671f0bc99d44936a3a051a/anthropics/claude-code/releases/tag/v2.1.219)
...
![](https://image.cnbcfm.com/api/v1/image/108173882-1752844539526-gettyimages-2225696381-mms28707_1cm2uml7.jpeg?v=1752844582&w=1920&h=1080)
...
![](https://pbs.twimg.com/media/HN_vsqtbgAAJ73S.jpg:large)
...
Claude-thermos 通过本地反向代理监控 Claude Code 会话，在主智能体因等待子智能体而空闲超过 5 分钟时，自动发送预热请求刷新提示缓存。实测约 185 次本地会话中，缓存过期导致的重新编码占账单约 22%。

工具以 uvx 运行，支持自定义空闲阈值和预热间隔。

![](https://opengraph.githubassets.com/004c0e8280a79819fa9450fe73244c07514055772140c5929f34ecdb20e85c12/izeigerman/claude-thermos)
...
![](https://cdn.prod.website-files.com/68a44d4040f98a4adf2207b6/6a639c6b2e881afef80764c6_og_the-new-rules-of-context-engineering-for-claude-5-generation-models.jpg)
...
Anthropic 产品设计师 Nate Parrott 分享了他在 Claude Design（beta 版）中利用 HTML 交互能力进行产品原型、幻灯片、动画等视觉创意探索与迭代的方法。

他将 Anthropic 品牌规范提炼为提示词，使输出自动符合品牌指南。Claude Design 不包含图像模型，不适合 Logo 设计，但可与 Claude Code 协同工作，将早期创意与生产开发衔接。

![](https://cdn.prod.website-files.com/68a44d4040f98a4adf2207b6/6a63a82fefafebcd8e7014b1_og_how-the-product-designer-who-built-claude-design-uses-it.jpg)
...
![](https://cdn.prod.website-files.com/68a44d4040f98a4adf2207b6/6a639bdab734de5ebb484e76_og_claude-models-explained-choosing-the-best-model-for-your-use-case.jpg)
